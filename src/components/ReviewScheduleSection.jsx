...
export default function ReviewScheduleSection() {
  ...
  return (
    <div>
      <p className="text-sm text-muted-foreground mb-3">Set preferred times for daily lecture reviews. Cedar will remind you to review your lectures at these times.</p>
