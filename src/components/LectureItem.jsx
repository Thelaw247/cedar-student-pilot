...
export default function LectureItem({ lecture, defaultInstructor, onUpdate, decayState }) {
  ...
  return (
    <div className="rounded-xl border border-border bg-card overflow-hidden">
          ...
          <>
            <div className="flex items-center gap-1.5 text-xs text-emerald-600 flex-1">
              ...
              <span className="font-medium">
                {lecture.is_ai_estimated ? 'Generated by AI' : `Taught by ${displayInstructor || 'Unknown'}`}
              </span>
              {!lecture.is_ai_estimated && lecture.actual_instructor && defaultInstructor && lecture.actual_instructor !== defaultInstructor && (
                <span className="text-muted-foreground">(guest / substitute)</span>
              )}
            </div>
            {/* AI-generated lectures were never taught by anyone — the
                instructor field is locked and can't be changed. */}
      ...
      {/* Inline instructor editor — never shown for AI-generated lectures */}
      {editing && !lecture.is_ai_estimated && (
