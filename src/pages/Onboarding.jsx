...
const STUDY_STYLES = [
  { id: 'cram', label: 'Cramming from messy notes the night before', answer: 'Cedar turns every lecture into a summary and flashcards the day it happens — studying starts already done.' },
...
const PROMISES = {
  'fast-prof': { title: 'Never miss a word again', lines: ['Record the lecture — Cedar transcribes every word', 'Replay anything at your own speed, with the transcript beside it', 'A clean summary and key concepts, minutes after class ends'] },
  notes: { title: 'Just listen. Cedar takes the notes.', lines: ['Hit record and put the pen down', 'Transcript, summary and action items appear after class', 'Your own quick notes attach to the exact lecture'] },
  exams: { title: 'Walk into every exam covered', lines: ['Every lecture becomes flashcards and practice questions', 'Cedar flags every exam mention your prof drops', 'Exam-topic prediction shows what to study first'] },
    ...
    <div className="min-h-screen bg-background flex flex-col">
      <div className="flex-1 flex items-center justify-center px-4 py-10">
        <div className="w-full max-w-md">
          ...
          {step === 0 && (
            <QuestionShell title="What&rsquo;s your biggest struggle this semester?" sub="Cedar shapes itself around your answer.">
          ...
          {step === 4 && exitOffer && (
            <div className="animate-fade-in text-center">
              ...
              <p className="text-sm text-muted-foreground mb-1">
                ...
                unlocked from day one — handbooks, exam predictions, AI schedules — is the best way to experience Cedar.
              </p>
