    ...
    return (
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-6 lg:py-10 animate-fade-in">
        ...
        <div className="rounded-xl border border-dashed border-border p-12 text-center">
          ...
          <p className="text-xs text-muted-foreground mb-4">Study something with the timer running and it shows up here.</p>
          <Link to="/study?tab=now" className="inline-flex items-center gap-1.5 px-4 py-2 rounded-lg bg-primary text-primary-foreground text-sm font-medium hover:bg-primary/90">
            Start studying
          </Link>
        </div>
      </div>
